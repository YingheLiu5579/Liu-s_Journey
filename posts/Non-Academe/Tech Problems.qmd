...
1. Wechat share button [Unsolved]
    Wechat disabled the Javascript hyperlink sharing function. I need to figure out a way to share my blog to Wechat. It seems that I am forced to use the Wechat QR code to share my blog. ~~"张小龙，____"~~
