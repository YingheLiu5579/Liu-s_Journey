...
![Memes from IGN](img/Elden Ring IGN Meme .jpeg) ***Memes draw from IGN.** Unique notes system allows players to leave messages for others. Sometimes the messages are helpful only in certain language context.*
